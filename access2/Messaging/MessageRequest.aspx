<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="MessageRequest.aspx.cs" Inherits="view.Messaging.MessageRequest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%--<div class="center-div">--%>
        <div class="row">
            <asp:Label ID="LabelTitle" runat="server" CssClass="col-lg-12 col-md-12 col-sm-12 col-xs-12 LabelCss"  Font-Size="Large" Text="Renseignement sur la Requête : "></asp:Label>
        </div>
        <div class="row">
            <asp:Label ID="Label35" CssClass="col-lg-2 col-md-2 col-sm-6 col-xs-12 LabelCss" runat="server" Text="Nom Utilisateur"></asp:Label>
       
            <asp:Label ID="Label_UserName" CssClass="col-lg-4 col-md-4 col-sm-6 col-xs-12 ComponentCss" runat="server"></asp:Label>

            <asp:Label ID="Label38" CssClass="col-lg-2 col-md-2 col-sm-6 col-xs-12 LabelCss" runat="server" Text="Structure"></asp:Label>

            <asp:Label ID="Label_Structure" CssClass="col-lg-4 col-md-4 col-sm-6 col-xs-12 ComponentCss" runat="server"></asp:Label>
        </div>
        <div class="row">
            <asp:Label ID="Label33" CssClass="col-lg-2 col-md-2 col-sm-6 col-xs-12 LabelCss" runat="server" Text="Nom de l'Agent"></asp:Label>

            <asp:Label ID="Label_AgentName" CssClass="col-lg-4 col-md-4 col-sm-6 col-xs-12 ComponentCss" runat="server"></asp:Label>
            <asp:Label ID="Label34" CssClass="col-lg-2 col-md-2 col-sm-6 col-xs-12 LabelCss" runat="server" Text="Prenom de l'Agent"></asp:Label>

            <asp:Label ID="Label_AgentFirstName" CssClass="col-lg-4 col-md-4 col-sm-6 col-xs-12 ComponentCss" runat="server"></asp:Label>
        </div>
    ...
    <div class="row">
        ...
        <ContentTemplate>
            <div id="DIV_ListView_Message" runat="server" style="overflow-x:auto;width:850px;overflow-y:auto;" visible="true">
    ...
    <br />
        <asp:ObjectDataSource ID="OdsMessages" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="getMessages" TypeName="controller.MessageRequestBLL" InsertMethod="InsertMessages">
            <InsertParameters>
                <asp:Parameter Name="IdUser_Sending" Type="String" />
                <asp:Parameter Name="IdUser_Receiving" Type="String" />
                <asp:Parameter Name="link" Type="String" />
                <asp:Parameter Name="message" Type="String" />
                <asp:Parameter Name="Request_Year" Type="Int32" />
                <asp:Parameter Name="NumWilaya" Type="Int32" />
                <asp:Parameter Name="NumRequest" Type="Int32" />
            </InsertParameters>
            <SelectParameters>
                <asp:Parameter DefaultValue="" Name="IdUser_Sending" Type="String" />
                <asp:Parameter Name="IdUser_Receiving" Type="String" DefaultValue="" />
                 <asp:Parameter Name="Request_Year" Type="Int32" DefaultValue=""/>
                <asp:Parameter Name="NumWilaya" Type="Int32" DefaultValue=""/>
                <asp:Parameter Name="NumRequest" Type="Int32" DefaultValue=""/>
            </SelectParameters>
        </asp:ObjectDataSource>

        <asp:ObjectDataSource ID="OdsMessageDetails" runat="server" InsertMethod="InsertMessages" OldValuesParameterFormatString="original_{0}" SelectMethod="GetMessageByUserName" TypeName="controller.MessageRequestBLL">
            <InsertParameters>
                <asp:Parameter Name="IdUser_Sending" Type="String" />
                <asp:Parameter Name="IdUser_Receiving" Type="String" />
                <asp:Parameter Name="link" Type="String" />
        ...
        <br />
    <div class="row">
        <asp:Label ID="Label36" runat="server"  CssClass="col-lg-12 col-md-12 col-sm-12 col-xs-12" Text="Le message :" ></asp:Label>
        
        <asp:TextBox ID="TextBox_Message" runat="server" CssClass="col-lg-12 col-md-12 col-sm-12 col-xs-12 textarea" TextMode="MultiLine" AutoPostBack="True" OnTextChanged="TextBox_Message_TextChanged"></asp:TextBox>
    </div>
