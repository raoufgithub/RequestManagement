...
{
    public partial class ModeTransmission : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            Guid id_trans = Guid.NewGuid();
            t.id_trans = id_trans.ToString();
            t.mode_trans = TextBox1.Text;
            
            bool confirm=ModeTranmission_Controller.insertModeTransmission(t);
        ...
        protected void Delete_LinkButton(object sender, EventArgs e)
        {
            ...
            if (confirmValue.Equals("s"))
            {
                ...
                bool confirm = ModeTranmission_Controller.deleteModeTransmission(num_selected);

                if (confirm) ScriptManager.RegisterClientScriptBlock(this.Page, this.Page.GetType(), "alert", "alert(\"Le mode de transmission '" + nom_selected + "' a été supprimée avec succès\");", true);
                ...
                else
                {
                    ...
                    ScriptManager.RegisterClientScriptBlock(this.Page, this.Page.GetType(), "alert", "alert(\"La suppression du mode de transmission '" + nom_selected + "'  a échoué  probablement la cause dûe à l'utilisation de cette ressource par des Requêtes \");", true);
                }
