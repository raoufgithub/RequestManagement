...
{
    public partial class DispositionPrise : System.Web.UI.Page
    {
        ...
        {
            Model.DispositionPrise dis = new Model.DispositionPrise();
            Guid DispositionPriseId = Guid.NewGuid();
            dis.DispositionPriseId = DispositionPriseId;
            dis.DispositionName = TextBox1.Text;

            dis.ObjectId = DropDownListObject.SelectedValue;
            ...
            DispositionPriseBLL.insertDispositionPrise(dis);
            //GridView1.DataBind();
