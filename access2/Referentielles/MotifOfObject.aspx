<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="MotifOfObject.aspx.cs" Inherits="view.Referentielles.MotifOfObject" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type = "text/javascript">
        function Confirm() {
            ...
            if (confirm("Voulez vous vraiment supprimer ce Motif de Requête?")) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
            <div class="row">
                <asp:Label ID="Label31" runat="server" CssClass="col-lg-12 col-md-12 col-sm-12 col-xs-12 LabelCss" Font-Size="Large" Text="La Création d'un Nouveau Motif de Requête"></asp:Label>
            </div>
            <div class="row">
                ...
                <div class="row">
                    ...
                    <asp:Label ID="Label32" runat="server" CssClass="col-lg-2 col-md-2 col-sm-5 col-xs-12 LabelCss" Text="Motif de Requête"></asp:Label>
                    <asp:TextBox ID="TextBox1" runat="server" CssClass="col-lg-3 col-md-3 col-sm-5 col-xs-12 ComponentCss"></asp:TextBox>
                    <asp:RequiredFieldValidator CssClass="col-lg-1 col-md-1 col-sm-2 col-xs-12" ID="RequiredFieldValidator1" ControlToValidate="TextBox1" ForeColor="Red"  runat="server" ErrorMessage="Le Motif est obligatoire" ValidationGroup="Validation">*</asp:RequiredFieldValidator>
                </div>
                <div class="row">     
    ...
    <asp:ObjectDataSource ID="OdsDispositif" runat="server" DataObjectTypeName="Model.dispositif" DeleteMethod="deleteDispositif" InsertMethod="insertDispositif" OldValuesParameterFormatString="original_{0}" SelectMethod="getAllDispositif" TypeName="controller.dispositif_controller" UpdateMethod="updateDispositif">
        ...
        <div class="DivCssRelance" style="overflow-x:auto;width:990px;overflow-y:auto; height:400px">
            ...
            <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                 <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="OdsMotifOfObject" ForeColor="#333333" GridLines="None" Width="968px" AllowPaging="true">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Motif" SortExpression="Motif">
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("MotifName") %>' Width="229px"></asp:TextBox>
                        &nbsp;
                        <asp:Label ID="Label1" runat="server" Text='<%# Bind("MotifId") %>' Visible="False"></asp:Label>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="Label2" runat="server" Text='<%# Bind("MotifName") %>'></asp:Label>
                        &nbsp;<asp:Label ID="Label1" runat="server" Text='<%# Bind("MotifId") %>' Visible="False"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
    ...
    <asp:ObjectDataSource ID="OdsMotifOfObject" runat="server" DataObjectTypeName="Model.Motif" DeleteMethod="deleteMotifOfObject" InsertMethod="insertMotifOfObject" OldValuesParameterFormatString="original_{0}" SelectMethod="getAllMotifOfObject" TypeName="controller.MotifObjectBLL" UpdateMethod="updateMotifOfObject">
        <DeleteParameters>
            <asp:Parameter Name="guid" Type="String" />
        </DeleteParameters>
    </asp:ObjectDataSource>
        <asp:ObjectDataSource ID="OdsMotifDispositif" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="getMotifByPhase" TypeName="controller.MotifDispositif_Controller">
                <SelectParameters>
